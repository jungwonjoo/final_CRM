  ...
  return (
    <aside className="flex w-full flex-col rounded-xl border bg-card p-4">
      ...
      <div className={cn("mt-3 flex-col gap-2.5 lg:flex", open ? "flex" : "hidden")}>
        <Input placeholder="고객지원, 고객, 고객사, 내용" />
        ...
        <Select>
          <SelectTrigger className="w-full">
            <SelectValue placeholder="접수자 미포함" />
          </SelectTrigger>
          <SelectContent>
            <SelectItem value="exclude">접수자 미포함</SelectItem>
            <SelectItem value="include">접수자 포함</SelectItem>
          </SelectContent>
        </Select>
